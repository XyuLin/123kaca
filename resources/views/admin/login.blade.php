...
<body class="page-body login-page">
            ...
            <div class="col-sm-6">
                                    ...
                                    success: function(resp)
                                    {
                                        show_loading_bar({
                                            ...
                                            finish: function(){
                                                ...
                                                {
                                                    toastr.error("你输入的密码错误，请再试一次。", "无效登录!", opts);
                                                    $passwd.select();
                                                }
                                                                                        }
                                        });
                ...
                <form method="post" role="form" id="login" class="login-form fade-in-effect">
                    ...
                    <div class="login-header">
                        <a href="/" class="logo">
                            <img src="{{ asset('kaca/img/logo2.png') }}" alt="" width="162px;" />
                        </a>
    ...
    <script src="{{ asset('kaca/admin/js/toastr/toastr.min.js') }}"></script>
